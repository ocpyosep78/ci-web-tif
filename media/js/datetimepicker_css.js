...
//	Tambahan
var base_url			= 'http://localhost/kospin/';	 
var pathimages = base_url+"other/images/";
...
function RenderCssCal(bNewCal) {
	...
	vCalHeader="<table "+CalBgColor+" background='"+ThemeBg+"' border=0 cellpadding=1 cellspacing=1 width='200px' valign='top' style='border:1px solid #666666;'>\n";
	...
	if (Cal.Scroller=="DROPDOWN") {
		vCalHeader+="<td align='center'><select name=\"MonthSelector\" onChange=\"javascript:Cal.SwitchMth(this.selectedIndex);RenderCssCal();\" class=\"text\">\n";
		for (i=0;i<12;i++) {
			if (i==Cal.Month)
				SelectStr="Selected";
			else
		...
		vCalHeader+="<td align='center'><select name=\"YearSelector\" size=\"1\" onChange=\"javascript:Cal.SwitchYear(this.value);RenderCssCal();\" class=\"text\">\n";
  ...
  //******************End Month and Year selector in arrow******************************
    ...
    if (UseImageFiles)
    {
       vCalTime+="<img onmousedown='javascript:closewin(\"" + Cal.Ctrl + "\"); stopSpin();' src='"+pathimages+"delete.png' width='16px' height='14px' onmouseover='changeBorder(this,0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white'></td>";
    }
    else
    {
